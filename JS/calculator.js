...
function addNumber(number){
    if(answerInNotANumber){
        clearAll();
        answerInNotANumber = false;
    }
...
function opEqual(){
    ...
    if(answer === 42) answer = 'The universe and everything.'; // Ester egg
    if(answer === 666) answer = 'THE DEVIL';

    answerInNotANumber = isNaN(answer);
